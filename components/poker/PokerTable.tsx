...
const getPlayerPosition = (index: number, total: number) => {
  // テーブル周りの位置を計算（円形配置）
  const positions = [
    { top: '50%', left: '50%', transform: 'translate(-50%, 110%)' }, // 下中央（自分）
    { top: '70%', left: '15%', transform: 'translate(0, 0)' }, // 左下
    { top: '30%', left: '10%', transform: 'translate(0, 0)' }, // 左上
    { top: '10%', left: '30%', transform: 'translate(0, 0)' }, // 上左
    { top: '5%', left: '50%', transform: 'translate(-50%, 0)' }, // 上中央
    { top: '10%', left: '70%', transform: 'translate(-100%, 0)' }, // 上右
    { top: '30%', right: '10%', transform: 'translate(0, 0)' }, // 右上
    { top: '70%', right: '15%', transform: 'translate(0, 0)' }, // 右下
  ];
          ...
          <div className="absolute top-[35%] left-1/2 transform -translate-x-1/2 flex gap-2">
            {communityCards.map((card, index) => (
              <motion.div
                ...
                className="playing-card w-16 h-22 flex flex-col items-center justify-center bg-white shadow-lg"
              >
